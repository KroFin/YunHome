...
<header class="main-header">
    <a href="all-admin-index.html" class="logo">
        <span class="logo-mini" style="width: 20%;height: 49px"><img style="width: 80%;margin-top: 10px" src="../img/house-logo.png"></span>
        <span class="logo-lg">
                    <i style="display: inline-block;margin-top: 10px;font-size: 14px">云租房-后台管理系统</i>
        </span>
    </a>
