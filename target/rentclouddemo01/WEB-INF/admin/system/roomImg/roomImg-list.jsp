                ...
                <div class="table-responsive" style="width: 100%">
                    <table id="dataList" class="table table-bordered table-striped table-hover dataTable" style="width: 1800px">
                        ...
                        <tr>
                            ...
                            <th class="sorting" style="width: 150px">房屋描述</th>
                        ...
                        <c:forEach items="${page.list}" var="item">
                            <tr>
                                ...
                                <td><a href="/system/user/toUpdate?id=${item.id}">${item.title}</a></td>
                                <td>${item.rent}</td>
                                <td>${item.roomType}</td>
                                ...
                                <td>
                                    <c:if test="${item.rent_status ==0}">待出租</c:if>
                                    <c:if test="${item.rent_status ==1}">已出租</c:if>
                                    <c:if test="${item.rent_status ==-1}">已下架</c:if>
                                </td>
